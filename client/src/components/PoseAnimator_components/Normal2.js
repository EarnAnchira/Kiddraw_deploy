...
const Normal2Page = () => {
    ...
    const showModal = () => {
        ...
        if (dataD.PageType === "normal" && (dataD.PageNoAnswer2Extra === PageNoAnswer2Extra)) {
            ...
            history(`/homeuser/${UserName}/${StoryID}/poseanimator/${dataD.PageNoNext}/n1/${PageNoAnswer1Extra}`);
        }
        else
            if (dataD.PageType === "normal" && dataD.PageNoAnswer1Extra !== PageNoAnswer1Extra && dataD.PageNoAnswer2Extra !== PageNoAnswer2Extra) {
                setIsOpen(false);
                history(`/homeuser/${UserName}/${StoryID}/poseanimator/${dataD.PageNoNext}/n1/${PageNoAnswer1Extra}/${PageNoAnswer2Extra}`);
            }
