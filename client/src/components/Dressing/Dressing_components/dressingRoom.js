...
import DressHead from './headlineDress.png';
...
function Dressing() {
    ...
    return (
        ...
        <img width="350" src={DressHead} style={{margin:"6rem 0px 50px 0px"}}></img>
            ...
            <button className="next_btn" onClick={handleSaveClick}>NEXT</button>
        </div>
    );
}
